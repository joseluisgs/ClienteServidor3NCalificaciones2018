 ...
 */
package clienteservidor3ncalificaciones;

import clienteservidor3ncalificaciones.controladores.ControladorAcceso;
import clienteservidor3ncalificaciones.controladores.ControladorAlumnos;
...
public class ControlCliente extends Thread {
    ...
    private void identificarUsuario() {
        try {
            ...
            ControladorAcceso a = ControladorAcceso.getInstancia();
    ...
    private void numAprobados() {
        ...
        ControladorAlumnos c = ControladorAlumnos.getInstancia();
